    ...
    <section id="writing" className="py-16 md:py-24 px-4 sm:px-6 md:px-12 max-w-6xl mx-auto w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {technicalArticles.map((article, idx) => (
          ...
          >
            <div>
              <div className="flex items-center justify-between text-xs font-mono text-[#525850] mb-4">
            ...
            <div className="pt-4 border-t border-[#e4e4dd] flex items-center justify-between text-xs font-mono text-[#525850]">
        ...
        {activeArticle && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/60 backdrop-blur-sm">
            ...
            >
              ...
              <div className="flex items-center gap-3 text-xs font-mono text-[#525850] mb-3">
              ...
              <div className="mt-8 pt-6 border-t border-[#e4e4dd] flex items-center justify-between">
                <span className="text-xs font-mono text-[#525850]">Author: Roshan Nale</span>
                <button
                  onClick={() => setActiveArticle(null)}
